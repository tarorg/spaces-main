...
<style>
    :global(:root) {
        ...
        --button: #f8f9fa;
        --button-hover: #f1f3f4;
        --button-active-hover: #e8eaed;
        --button-hover-transparent: rgba(0, 0, 0, 0.04);
        --button-stroke: rgba(0, 0, 0, 0.04);
        --button-text: #202124;
        --button-box-shadow: 0 0 0 1px var(--button-stroke) inset;

        --button-elevated: #ffffff;
        --button-elevated-hover: #f8f9fa;
        --button-elevated-shimmer: #ffffff;
